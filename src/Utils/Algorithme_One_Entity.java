	...
	public static void launch(HttpServletRequest request){
		synchronized(key){
			try{
				...
				// On r�cup�re la pair � traiter
				Pair pair = DBService.SELECT_PAIR_BY_ID(idPair);
				
				// On r�cup�re les attributs de la pair
				...
				// On met � jour la note de chaque attributs
				...
				if(tauxVote>0){
					...
					// On g�n�re l'enregistrement dans la table de similarit� pour les nouvelles moyennes d'attributs
